...
big_loop:
	LDR	R0, =t_start	// R0 -> t_start
	LDR	R1, =0		// R1 = 0
	BL	gettimeofday	// Parameters: R0--R1
	LDR	R0, =POS	// R0 -> POS
...
wait_here:
	...
	BL	gettimeofday	// Parameters: R0--R1
	LDR	R0, =t_end	// R0 -> t_end
	LDR	R0, [R0, #4]	// R0 = t_end.microseconds
	LDR	R1, =t_start	// R1 -> t_start
	LDR	R1, [R1, #4]	// R1 = t_start.microseconds
	SUB	R0, R0, R1	// R0 = elapsed microseconds
	LDR	R2, =FPS_MICROS	// R2 -> FPS_MICROS
	LDR	R2, [R2]	// R2 = FPS_MICROS
	SUB	R0, R2, R0	// R2 = FPS_MICROS - elapsed
